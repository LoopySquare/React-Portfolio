    ...
    return (
      <div className='about-me'>
        ...
        <div className='about-text-box'>
          <p className='about-text'>Hello, my name is Tommy Jobin. I am an aspiring full stack web developer and an experienced graphic designer. I am currently learning HTML, CSS, JavaScript, React, Node, MySQL, and more. As for the design side, I have several years of experience with Adobe Photoshop, Illustrator, and inDesign. When I am not working you can find me playing one of my favorite video games, going for a hike, snowboarding, or watching the Minnesota Vikings attempt to win a football game.</p>
